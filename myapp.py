...
#Reviso la cantidad de NaNs mi nueva base de datos "Valores"
valores.isnull().sum()

#Definimos preferencias y encuestados

preferencias = valores[valores.columns[1:]].to_numpy()   #n
encuestados = valores[valores.columns[0]].to_numpy()   #m
st.write("""
##### Se presenta la correlacion en pandas
""")
preferencias.T
...
# definimos correlacion pandas

m_corr_pandas = matriz.corr()

#Se aproxima la correlacion de pandas a 4 decimales
